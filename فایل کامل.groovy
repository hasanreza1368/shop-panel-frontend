...
const ShopPanel = () => {
    ...
    useEffect(() => {
        ...
        const ws = new WebSocket(`ws://localhost:5000?phone=${phone}`);
    ...
    // 👈 کامپوننت دکمه کارت به کارت با افکت Swiping Glow
    const CardToCardButton = ({ onClick, disabled }) => {
        const EMERALD_COLOR = "#059669"; // سبز زمردی
        ...
        return (
            <motion.button
                ...
                style={{
                    ...
                    backgroundColor: EMERALD_COLOR, color: 'white', fontWeight: 'bold',
                    display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.5rem',
                    opacity: disabled ? 0.5 : 1, cursor: disabled ? 'not-allowed' : 'pointer',
                    position: 'relative', // برای افکت نور
                    overflow: 'hidden',
                }}
            >
                {/* 👈 افکت نور ملایم حرکتی (Swiping Glow) */}
                <motion.div
                        ...
                        >
                            ...
                            <motion.button
                                ...
                                style={{
                                    ...
                                    display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.5rem',
                                    opacity: (isLoading || !selectedProduct) ? 0.5 : 1,
                                    cursor: (isLoading || !selectedProduct) ? 'not-allowed' : 'pointer'
                                }}
                                onClick={handleAddToCart} disabled={isLoading || !selectedProduct}
                            >
                                <ShoppingCart size={20} /> افزودن به سبد
                            </motion.button>
                        </div>
...
/>
                                ...
                                <motion.button
                                    ...
                                    style={{
                                        ...
                                        color: 'white',
                                        fontWeight: 'bold',
                                        boxShadow: '0 0 15px rgba(109, 40, 217, 0.8), 0 0 25px rgba(37, 117, 252, 0.6)',
                                        display: 'flex',
                                        alignItems: 'center',
                                        justifyContent: 'center',
                                        gap: '0.7rem',
